                ...
                {dayTodos.map(todo => (
                  ...
                  >
                    ...
                    <div className="flex-1 min-w-0">
                      {/* TIDPUNKT SEKTION: Kompakt och smalare för att inte krocka */}
                      <div className="flex items-center gap-1.5 mb-0.5">
                        <div className="flex items-center gap-0.5 text-[9px] font-mono font-bold bg-black/5 dark:bg-white/10 px-1 rounded w-10 shrink-0 justify-center">
                          {todo.time ? todo.time : "--:--"}
                        </div>
                        {todo.recurrence !== "NONE" && (
                          <RefreshCw className="h-2.5 w-2.5 text-primary shrink-0" />
                        )}
                      </div>
                    ...
                    {!isReadOnly && (
                      <button
                        ...
                        className="opacity-0 group-hover/todo:opacity-100 transition-opacity p-1 hover:text-red-500 rounded bg-background/20 shrink-0"
                      >
